...
class ConfusionMatrix:
    def __init__(self, predictions: Tensor, targets: str, classes:List[str],save_path: str) -> None:
    ...
    def generate_conf_matrix(
        ...
        self.conf_matrix = pd.DataFrame(self.conf_matrix.numpy(), 
    ...
    def plot_conf_matrix(self) -> None:
        ...
        conf_fig = sns.heatmap(self.conf_matrix, 
                    annot=True,
